...
switch (GAME_MODE) {
  case "relaxed":
    ...
    cardNumbers = [
      ...
      91, 92, 94, 95, 110, 113, 114, 115, 116, 117, 118,
    ];
    break;
  case "extreme":
    useSameCards = true;
  ...
  case "hardcore":
    ...
    cardNumbers = [
      ...
      72, 73, 74, 75, 76, 77, 78, 79, 80, 83, 84, 85, 87, 88, 89, 90, 91, 92,
      93, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 112,
